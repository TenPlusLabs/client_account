...
const Rows = [
    ...
    {id:6, page_title:'TenPlus Labs', page_url:'AJAPswenky', date_published:'05-01-2021', date_description:'0', meta_data:'2021/05/05', visit_day:'0', visit_today:'5', visit_month:'2' }
]
    ...
    return(        
        ...
        <tr>
            ...
            <td className='page_title'> {page_title}
                ...
                <button className='btn btn-primary mt-3 mr-3' onClick={() => {
                  handleShow();
                }}>Edit</button><button className='btn btn-primary mt-3'>Delete</button>
                </div>
             </td>
            <td>{page_url}</td>
