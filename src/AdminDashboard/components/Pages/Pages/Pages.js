...
const columns = [
    ...
    { field: 'todayVisit', headerName: 'Number of visit"s today', width: 90, },
    { field: 'oneWeekVisit', headerName: 'Number of visit"s in 7 days', width: 90, },
    { field: 'oneMonthVisit', headerName: 'Number of visit"s in 1 month', width: 90, },
  ];
